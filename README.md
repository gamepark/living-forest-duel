...
Once you have one Material type and one Location type, you can start to setup a new game in [LivingForestDuelRules.ts](/rules/src/LivingForestDuelRules.ts)
